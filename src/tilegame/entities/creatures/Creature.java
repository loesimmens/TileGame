...
public abstract class Creature extends Entity
{
    ...
    public Creature(World world, float x, float y, int width, int height, int id, String name) 
    {
    ...
    {
        g.drawImage(getCurrentAnimationFrame(), (int) (x - world.getGameState().getGame().getGameCamera().getxOffset()), 
